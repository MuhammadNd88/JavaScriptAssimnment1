...
var qoutelength = quote.length;
//Log out the length
console.log(qoutelength);
...
var attributedQoute = "- Rear Admiral Grace Hopper";
var qoute = console.log(quote + " " + attributedQoute);

//4. Create a function `attribute` that takes a quote and author and returns the attributed quote.

function attribute(qoute, auther) {
  return qoute + " " + auther;
}
var qoute1 =
  "The key to being a successful programmer is to learn how to learn.";
var author1 = "- Shannon Burns";
console.log(qoute1, author1);
...
function sumFiveNumber(x, y, z, p, q) {
  return x + y + z + p + q;
...
console.log(sumFiveNumber(2, 2, 3, 4, 5));
